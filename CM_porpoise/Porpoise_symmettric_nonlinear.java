...
public class Porpoise extends Agent {
	...
	public void deter(final double currentDeterenceStrength, final NdPoint srcPosition) {
		...
		if (this.deterStrength < currentDeterenceStrength) {
			...
			this.deterVt[0] = (currentDeterenceStrength/(1+Math.exp(-(this.energyLevel-10)))) * ((porpPosition.getX() - srcPosition.getX()));
			this.deterVt[1] = (currentDeterenceStrength/(1+Math.exp(-(this.energyLevel-10)))) * ((porpPosition.getY() - srcPosition.getY()));
