...
public class Porpoise extends Agent {
	...
	public void deter(final double currentDeterenceStrength, final NdPoint srcPosition) {
		...
		if (this.deterStrength < currentDeterenceStrength) {
			...
			this.deterVt[0] = ((currentDeterenceStrength/20)*this.energyLevel) * ((porpPosition.getX() - srcPosition.getX()));
			this.deterVt[1] = ((currentDeterenceStrength/20)*this.energyLevel) * ((porpPosition.getY() - srcPosition.getY()));
